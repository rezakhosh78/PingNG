...
object SettingsManager {
    ...
    /**
     * Returns the optional upstream HTTP CONNECT proxy used to reach the selected node.
     * A malformed or incomplete setting is treated as disabled so it cannot break startup.
     */
    fun getConnectHttpProxy(): HttpProxySettings? {
