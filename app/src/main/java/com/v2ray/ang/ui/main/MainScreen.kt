...
fun MainScreen(
    ...
    var desyncTarget by remember { mutableStateOf<Pair<String, ProfileItem>?>(null) }
    ...
    desyncTarget?.let { (guid, profile) ->
        DesyncSettingsDialog(
            profile = profile,
            onSave = { desyncProfile, customArgs ->
                onAction(MainAction.SaveDesync(guid, profile, desyncProfile, customArgs))
            },
            onDismiss = { desyncTarget = null },
        )
    }
                ...
                Column(
                    ...
                    HorizontalPager(
                        ...
                        GroupPagerPage(
                            ...
                            onDesyncServer = { guid, profile -> desyncTarget = guid to profile },
