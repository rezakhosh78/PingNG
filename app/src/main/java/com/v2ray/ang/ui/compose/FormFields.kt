...
fun FormTextField(
    ...
    Box(
        ...
        OutlinedTextField(
            ...
            maxLines = maxLines,
            enabled = enabled,
            textStyle = textDirection?.let { LocalTextStyle.current.copy(textDirection = it) }
...
/** TextFieldValue variant used where cursor/selection must survive formatting. */
@Composable
fun FormTextFieldValue(
    label: String,
