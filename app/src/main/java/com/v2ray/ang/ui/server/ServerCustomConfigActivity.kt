...
class ServerCustomConfigActivity : BaseComponentActivity() {
    ...
    override fun ScreenContent() {
        ServerCustomConfigScreen(
            ...
            onBackClick = { finish() },
            onSave = { remarks, content, psiphonEnabled, psiphonRegion, mode, ips, sni, sets ->
                saveServer(remarks, content, psiphonEnabled, psiphonRegion, mode, ips, sni, sets)
            },
    ...
    private fun saveServer(
        ...
        val originalConfig = config.copy()
        ...
        if (editGuid.isNotBlank() && config.subscriptionId.isNotBlank()) {
            SubscriptionProfileOverrides.save(editGuid, originalConfig, config)
        }
...
fun ServerCustomConfigScreen(
    ...
    onBackClick: () -> Unit,
    onSave: (String, String, Boolean, String, String, String, String, String) -> Boolean,
    onDelete: () -> Unit
) {
        ...
        topBar = {
            AppTopBar(
                ...
                actions = {
                    ...
                    IconButton(onClick = {
                        onSave(remarks, textFieldState.text.toString(), psiphonEnabled, psiphonRegion, psiphonMode, psiphonCdnIps, psiphonCdnSni, psiphonCdnSets)
                    }) {
                        Icon(
