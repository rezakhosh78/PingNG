...
object AppConfig {
    ...
    const val PREF_CONNECT_HTTP_PROXY = "pref_connect_http_proxy"
    const val PREF_CONNECT_HTTP_PROXY_HOST = "pref_connect_http_proxy_host"
    const val PREF_CONNECT_HTTP_PROXY_PORT = "pref_connect_http_proxy_port"
    const val PREF_CONNECT_HTTP_PROXY_USERNAME = "pref_connect_http_proxy_username"
    const val PREF_CONNECT_HTTP_PROXY_PASSWORD = "pref_connect_http_proxy_password"
    ...
    const val SERVERLESS_SUBSCRIPTION_ID = "serverless_for_iran"
    const val SERVERLESS_SUBSCRIPTION_URL = "https://raw.githubusercontent.com/patterniha/Serverless-for-Iran/refs/heads/main/Subscription/Serverless-for-Iran.json#ServerLess"
    const val SERVERLESS_SUBSCRIPTION_REMARKS = "ServerLess"
    ...
    const val ACTION_PSIPHON_RUNTIME = "$ANG_PACKAGE.action.psiphon_runtime"
    const val PSIPHON_RUNTIME_START = "start"
    const val PSIPHON_RUNTIME_STOP = "stop"
    const val EXTRA_PSIPHON_GUID = "psiphon_guid"
    const val EXTRA_PSIPHON_REGION = "psiphon_region"
    const val EXTRA_PSIPHON_MODE = "psiphon_mode"
    const val EXTRA_PSIPHON_CDN_IPS = "psiphon_cdn_ips"
    const val EXTRA_PSIPHON_CDN_SNI = "psiphon_cdn_sni"
    const val EXTRA_PSIPHON_CDN_SETS = "psiphon_cdn_sets"
    const val EXTRA_PSIPHON_UPSTREAM_PORT = "psiphon_upstream_port"
    const val EXTRA_PSIPHON_STATE = "psiphon_state"
    const val EXTRA_PSIPHON_SOCKS_PORT = "psiphon_socks_port"
    const val EXTRA_PSIPHON_MESSAGE = "psiphon_message"
    ...
    const val APP_URL = "https://github.com/rezakhosh78/PingNG"
    const val APP_API_URL = "https://api.github.com/repos/rezakhosh78/PingNG/releases"
    ...
    const val TG_CHANNEL_URL = "https://t.me/pingplas_channel"
    ...
    const val MSG_PSIPHON_STATUS = 75
    const val MSG_MASTERDNS_PROGRESS = 76
    ...
    const val RAY_NG_CHANNEL_ID = "CORE_M_CH_ID_PINGNG"
    const val RAY_NG_CHANNEL_NAME = "PingNG"
