...
اجرای کانفیگ بدون Desync

Light

پردازش سبک با سازگاری گسترده

Balanced

تعادل مناسب برای استفاده‌ی روزمره

Severe

پردازش قوی‌تر برای شبکه‌های محدودتر

Adaptive

رفتار تطبیقی متناسب با اتصال

Custom

کنترل کامل پارامترهای موجود
...
بر پایه‌ی پروژه‌ی و PattNG 2dust/v2rayNG
